    ...
    const costs: CostBreakdown[] = [
      {
        ...
        total_cost_usd: 2.5,
        cost_by_stage: { plan: 0.5, work: 1.5, review: 0.5, investigate: 0 },
      },
    ];
    ...
    const costs: CostBreakdown[] = [
      {
        ...
        task_title: "Task A",
        total_cost_usd: 1.0,
        cost_by_stage: { plan: 0.2, work: 0.6, review: 0.2, investigate: 0 },
      },
      {
        task_id: "t2",
        task_title: "Task B",
        total_cost_usd: 2.0,
        cost_by_stage: { plan: 0.4, work: 1.2, review: 0.4, investigate: 0 },
      },
    ];
    render(<CostWidget costs={costs} costByStage={costByStage} />);
